                                                        ...
                                                        <div class="tab-content">
                                                            <div class=" active tab-pane " id="tab_1_1">
                                                                <div class="tiles">
                                                                    ...
                                                                    <a href="Master/DemoContent/DemoContentList.aspx">
                                                                        <div class="tile bg-blue">
                                                                            <div class="tile-body">
                                                                                <i class="fa fa-list"></i>
                                                                            </div>
                                                                    ...
                                                                    <a href="Account/ACC_Expense/ACC_ExpInm_Ledger.aspx">
                                                                        <div class="tile bg-red">
                                                                            <div class="tile-body">
                                                                                <i class="fa fa-list"></i>
                                                                            </div>
                                                                            <div class="tile-object">
                                                                                <div class="name">Account Ledger</div>
                                                                                <div class="number"></div>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                            ...
                                                            <div class="tab-pane " id="tab_1_2">
                                                                <div class="tiles">
                                                                    ...
                                                                    <a href="Master/DemoContent/DemoContentAddEdit.aspx">
                                                                        <div class="tile bg-blue">
                                                                            <div class="tile-body">
                                                                                <i class="fa fa-edit"></i>
                                                                            </div>
