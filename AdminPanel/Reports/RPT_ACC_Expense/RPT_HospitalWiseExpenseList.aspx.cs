...
public partial class AdminPanel_Reports_RPT_ACC_Expense_RPT_HospitalWiseExpenseList : System.Web.UI.Page
{
    ...
    {
        String ReportSubTitle = "Expense Report";
        ...
        this.rvHospitalWiseExpenseList.LocalReport.SetParameters(new ReportParameter[] { rptReportTitle, rptPrintDate, rptReportSubTitle });
    }
