                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                            ...
                                            <asp:TextBox ID="dtpFromDate" CssClass="form-control" runat="server" placeholder="Ledger FromDate"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                            ...
                                            <asp:TextBox ID="dtpToDate" CssClass="form-control" runat="server" placeholder="Ledger ToDate"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
