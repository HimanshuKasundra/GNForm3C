...
public partial class AdminPanel_MasterDashboard3 : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        foreach (RepeaterItem rpAc in rpFinYear.Items)
        {
            ...
            DataTable dtCount = balMasterDashboard2BAL.SelectCount(FinYearID);
    ...
    private void BindCategoryWiseExpenseTotalList(Repeater rp, SqlInt32 FinYearID)
    {
        ...
        DataTable dtCategoryWiseExpenseTotalList = balMasterDashboard2BAL.CategoryWiseExpenseTotalList(FinYearID);
    ...
    private void BindHospitalWisePatientCountList(Repeater rp, SqlInt32 FinYearID)
    {
        ...
        DataTable dtHospitalWisePatientCountList = balMasterDashboard2BAL.HospitalWisePatientCountList(FinYearID);
    ...
    private void BindAccountTranscationList(Repeater rp, SqlInt32 FinYearID)
    {
        ...
        DataTable dtAccountTranscationList = balMasterDashboard2BAL.AccountTranscationList(FinYearID);
