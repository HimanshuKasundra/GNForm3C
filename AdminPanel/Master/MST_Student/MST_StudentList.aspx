                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    ...
                                    <asp:HyperLink SkinID="EditPopup" ID="hlAddNew" NavigateUrl="~/AdminPanel/Master/MST_Student/MST_StudentAddEditPopup.aspx"  data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                ...
                                                                <asp:HyperLink ID="hlEdit" SkinID="EditPopup" NavigateUrl='<%# "~/AdminPanel/Master/MST_Student/MST_StudentAddEditPopup.aspx?StudentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("StudentID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
