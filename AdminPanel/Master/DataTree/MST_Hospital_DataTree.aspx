                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:DropDownList ID="ddlHospitalID" CssClass="First form-control" runat="server" PlaceHolder="Enter Hospital"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:DropDownList ID="ddlFinYearID" CssClass="form-control" runat="server" PlaceHolder="Enter FinYear Name"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <table class="table table-bordered table-advanced table-striped table-hover">
                                                <thead>
                                                    <tr class="TRDark">
                                                        ...
                                                        <th class="text-left" style="width: 5%;">Sr</th>
                                                        <th>Hospital</th>
                                                        <th>PrintName</th>
                                                        <th>PrintLine1</th>
                                                        <th>Remarks</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td class="text-center">
                                                    ...
                                                    <asp:Button ID="btnShowFinYears" runat="server" CssClass="btn blue btn-circle btn-sm" Text="+" CommandName="LoadFinYears" CommandArgument='<%# Eval("HospitalID") %>' />
                                                </td>
                                                <th class="text-left" style="width: 5%;"><%# Container.ItemIndex + 1 %></th>
                                                <td>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr class="odd gradeX">
                                                                                <td class="text-center" style="width: 5%;">
                                                                                    ...
                                                                                    <asp:Button ID="btnShowMonths" CssClass="btn blue btn-circle btn-sm" runat="server" Text="+" CommandName="LoadMonths" CommandArgument='<%# Eval("FinYearID") %>' />
                                                                                </td>
                                                                                 <td class="text-left" style="width: 5%;"><%# Container.ItemIndex + 1 %></td>
                                                                                <td class="text-center">
                                                                                ...
                                                                                <td class="text-center"><%# Eval("FromDate",GNForm3C.CV.DefaultDateFormatForGrid) %></td>
                                                                                <td class="text-center"><%# Eval("ToDate",GNForm3C.CV.DefaultDateFormatForGrid) %></td>
                                                                                <td class="text-left"><%# Eval("Remarks") %></td>
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr class="odd gradeX">
                                                                                                            <td class="text-center" style="width: 5%;">
                                                                                                                ...
                                                                                                                <asp:Button ID="btnShowIncomes" SkinID="" CssClass="btn blue btn-circle btn-sm" runat="server" Text="+" CommandName="LoadIncomes" CommandArgument='<%# Eval("Date") %>' />
                                                                                                            </td>
                                                                                                            <td class="text-left" style="width: 5%;"><%# Container.ItemIndex + 1 %></td>
    ...
    <script type="text/javascript">
        function togglePanel(button, panelId) {
            ...
            if (panel.style.display === "none" || panel.style.display === "") {
                panel.style.display = "table-row";  // or "block" depending on your layout
                button.value = "-";
            } else {
