<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MasterDashboard3.aspx.cs" Inherits="AdminPanel_MasterDashboard3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <li>
        ...
        <asp:HyperLink ID="hlHome" runat="server" NavigateUrl="~/AdminPanel/MasterDashboard3.aspx" Text="Dashboard"></asp:HyperLink>
                                                                            ...
                                                                            <div class="portlet light">
                                                                                ...
                                                                                <div>
                                                                                    <ul class="nav nav-tabs">
                                                                                        <li class="active">
                                                                                            <asp:LinkButton ID="lbtnCol" runat="server" href=' <%# "#tab_Inc_CategoryWiseIncomeTotalList" + Eval("FinYearID") %>' Text="Category Wise Income List" data-toggle="tab"></asp:LinkButton>
                                                                                        </li>
                                                                                        <li class="">
                                                                                            <asp:LinkButton ID="LinkButton3" runat="server" href=' <%# "#tab_Inc_CategoryWiseExpenseTotalList" +  Eval("FinYearID") %>' Text="Category Wise Expense List" data-toggle="tab"></asp:LinkButton>
                                                                                        </li>
                                                                                        <li class="">
                                                                                            <asp:LinkButton ID="LinkButton4" runat="server" href=' <%# "#tab_Inc_HospitalWisePatientCountList" + Eval("FinYearID") %>' Text="Hospital Wise Patient List" data-toggle="tab"></asp:LinkButton>
                                                                                        </li>
                                                                                        <li class="">
