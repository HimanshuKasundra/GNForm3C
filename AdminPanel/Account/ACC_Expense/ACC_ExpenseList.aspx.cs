...
public partial class AdminPanel_ACC_Expense_ACC_ExpenseList : System.Web.UI.Page
{
    ...
    private void Search(int PageNo)
     {
        ...
        DataTable dt = balACC_Expense.SelectPage(Offset, PageRecordSize, out TotalRecords, ExpenseTypeID, Amount,TagName, ExpenseDate, HospitalID, FinYearID);
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        if (txtTagName.Text.Trim() != String.Empty)
            FinYearID = Convert.ToInt32(txtTagName.Text.Trim());
        ...
        ACC_ExpenseBAL balACC_Expense = new ACC_ExpenseBAL();
        DataTable dtACC_Expense = balACC_Expense.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, ExpenseTypeID, Amount,TagName, ExpenseDate, HospitalID, FinYearID);
