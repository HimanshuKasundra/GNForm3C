                    ...
                    <div class="form-horizontal" role="form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">
                                    <span class="required">*</span>
                                    <asp:Label ID="txtTagName1_XXXXX" runat="server" Text="TagName"></asp:Label>
                                </label>
                                <div class="col-md-5">
                                    <asp:TextBox ID="txtTagName1" CssClass="form-control" runat="server"  PlaceHolder="Enter TagName"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvTagName" runat="server" ControlToValidate="txtTagName1" ErrorMessage="Enter TagName" Display="Dynamic" Type="Text"></asp:RequiredFieldValidator>
