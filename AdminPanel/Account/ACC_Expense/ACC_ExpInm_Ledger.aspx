<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="ACC_ExpInm_Ledger.aspx.cs" Inherits="AdminPanel_Account_ACC_Expense_ACC_ExpInm_Ledger" %>
                                ...
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped " id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th class="text-center col-md-3 " style="font-weight: bold;" >  
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" >
                                                    <ItemTemplate>
                                                        <%-- Table Rows --%>
                                                        <tr class="odd gradeX" style='<%# Eval("LedgerType").ToString() == "Income" ? "background-color: lightgreen; color: black;": "background-color: red; color: black;" %>'>
