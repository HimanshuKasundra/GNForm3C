<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="ACC_TransactionTranList.aspx.cs" Inherits="AdminPanel_ACC_TransactionTran_ACC_TransactionTranList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
	<asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Transaction Tran"></asp:Label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="TransactionTran"></asp:Label>
    </li>
</asp:Content>
									...
									<div class="form-group">
										<div class="input-group">
											<span class="input-group-addon">
									       	...
									       	<asp:DropDownList ID="ddlTransactionID" CssClass="First form-control select2me" runat="server"></asp:DropDownList>
										</div>
									</div>
								</div>
								<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtQuantity" CssClass="form-control" runat="server"  PlaceHolder="Enter Quantity"></asp:TextBox>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtRate" CssClass="form-control" runat="server"  PlaceHolder="Enter Rate"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                 <div>
									<asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Account/ACC_TransactionTran/ACC_TransactionTranAddEdit.aspx" runat="server"></asp:HyperLink>
                                        ...
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th><asp:Label ID="lbhQuantity" runat="server" Text="Quantity"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhUnit" runat="server" Text="Unit"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhRate" runat="server" Text="Rate"></asp:Label>
                                                    </th>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Account/ACC_TransactionTran/ACC_TransactionTranView.aspx?TransactionTranID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("TransactionTranID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
								<asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Account/ACC_TransactionTran/ACC_TransactionTranAddEdit.aspx?TransactionTranID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("TransactionTranID").ToString()) %>' runat="server"></asp:HyperLink>
                                                                <asp:LinkButton ID="lbtnDelete" runat="server"
                                                                    SkinID="Delete"
                                                                    OnClientClick="javascript:return confirm('Are you sure you want to delete record ? ');"
                                                                    CommandName="DeleteRecord"
                                                                    CommandArgument='<%#Eval("TransactionTranID") %>'>
                                                                </asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                        <%-- END Table Rows --%>
