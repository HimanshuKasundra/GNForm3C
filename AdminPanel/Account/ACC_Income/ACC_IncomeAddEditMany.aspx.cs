                    ...
                    try
                    {
                        ...
                        if (Hdfiled.Value != string.Empty)
                        {
                            if (chkIsSelected.Checked)
                            {
                                ...
                                else if (txtIncomeDate.Text.Trim() != string.Empty)
                                {
                        ...
                        else
                        {
                            if (chkIsSelected.Checked)
                            {
                                ...
                                if (txtAmount.Text.Trim() == string.Empty && txtIncomeDate.Text.Trim() != string.Empty)
                                {
                                    txtAmount.Focus();
                                    ucMessage.ShowError("Enter Amount");
                                }
                                else if (txtAmount.Text.Trim() != string.Empty && txtIncomeDate.Text.Trim() == string.Empty)
                                {
