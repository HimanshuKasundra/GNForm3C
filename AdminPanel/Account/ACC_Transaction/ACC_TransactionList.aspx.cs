...
public partial class AdminPanel_ACC_Transaction_ACC_TransactionList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["HospitalID"] != null && Request.QueryString["FinYearID"] != null && Request.QueryString["TreatmentID"] != null)
            {
    ...
    private void Search(int PageNo)
    {
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            if (Request.QueryString["HospitalID"] != null && Request.QueryString["FinYearID"] != null && Request.QueryString["TreatmentID"] != null)
            {
                ...
                FinYearID = CommonFunctions.DecryptBase64Int32(Request.QueryString["FinYearID"]);
                ddlFinYearID.SelectedIndex = Convert.ToInt32(FinYearID.ToString());
                TreatmentID = CommonFunctions.DecryptBase64Int32(Request.QueryString["TreatmentID"]);
