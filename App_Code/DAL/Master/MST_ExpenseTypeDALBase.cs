...
namespace GNForm3C.DAL
{
	public abstract class MST_ExpenseTypeDALBase : DataBaseConfig
	{
        ...
        public DataTable SelectComboBoxExpenseTypeWithHospital()
        {
            try
            {
                SqlDatabase sqlDB = new SqlDatabase(myConnectionString);
                DbCommand dbCMD = sqlDB.GetStoredProcCommand("PR_MST_ExpenseTypeWithHospital_SelectComboBox");

                DataTable dtMST_ExpenseType = new DataTable("PR_MST_ExpenseTypeWithHospital_SelectComboBox");
