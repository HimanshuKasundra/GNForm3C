...
namespace GNForm3C.BAL
{
	public abstract class CFG_SoftwareConfigurationBALBase
	{
		...
		{
			CFG_SoftwareConfigurationDAL dalCFG_SoftwareConfiguration = new CFG_SoftwareConfigurationDAL();
			return dalCFG_SoftwareConfiguration.SelectPage(PageOffset, PageSize, out TotalRecords, SaveMessage_NoMessageJustClosetheform, SaveMessage_ShowMessageClosetheform, SaveMessage_ShowMessageAskforOtherRecord,
