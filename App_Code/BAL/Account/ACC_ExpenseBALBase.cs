...
namespace GNForm3C.BAL
{
	public abstract class ACC_ExpenseBALBase
	{
		...
		public DataTable SelectPage(SqlInt32 PageOffset, SqlInt32 PageSize, out Int32 TotalRecords, SqlInt32 ExpenseTypeID, SqlDecimal Amount,SqlString TagName, SqlDateTime ExpenseDate, SqlInt32 HospitalID, SqlInt32 FinYearID)
		{
			ACC_ExpenseDAL dalACC_Expense = new ACC_ExpenseDAL();
			return dalACC_Expense.SelectPage(PageOffset, PageSize, out TotalRecords, ExpenseTypeID, Amount,TagName, ExpenseDate, HospitalID, FinYearID);
		}
